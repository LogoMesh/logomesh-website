...
export const metadata: Metadata = {
  ...
  description:
    "When your error monitor fires, LogoMesh reads the program state at the moment of failure and writes a failing pytest that reproduces the crash. Zero LLM in the repro path. Python. Free during beta.",
  icons: {
  ...
  openGraph: {
    title: "LogoMesh",
    description:
      "Reads the crash. Reproduces it from frame locals. Hands you a failing pytest in about 60 seconds. Built for Python fintech.",
    type: "website",
  },
};
