  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full min-w-0 max-w-[920px] rounded-[2rem] border border-[var(--color-border)] bg-[var(--color-canvas-2)]/45 px-5 py-12 shadow-[0_32px_80px_-40px_rgba(0,0,0,0.65),inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-sm sm:rounded-[2.25rem] sm:px-12 sm:py-16 md:px-16 md:py-20 lg:px-20 lg:py-24">
        ...
        >
          A guided wizard takes you from zero to your first reproducible crash artifact in about the time it takes to
          ...
          {WIZARD_STEPS.map((step, i) => (
            ...
            >
              ...
              <Check
                size={13}
                strokeWidth={2.5}
                className="ml-auto text-[var(--color-accent)]/70"
                aria-hidden
              />
            </li>
          ))}
        ...
        <div data-reveal className="relative flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <motion.a
            href="/onboarding"
