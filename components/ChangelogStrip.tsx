...
export function ChangelogStrip() {
  return (
    ...
    >
      ...
      >
        <span className="flex-shrink-0 font-[family-name:var(--font-mono)] text-[11.5px] font-bold uppercase tracking-[0.12em] text-[var(--color-muted)] flex items-center gap-2">
          <span
        ...
        <div className="flex items-center gap-6 flex-shrink-0">
          {CHANGES.map((c, i) => (
            <div key={i} className="flex items-center gap-3 flex-shrink-0">
              <span className="font-[family-name:var(--font-mono)] text-[11.5px] text-[var(--color-dim)] whitespace-nowrap">
                {c.date}
              </span>
              <span className="font-[family-name:var(--font-mono)] text-[12.5px] text-[var(--color-muted)] whitespace-nowrap">
                {c.title}
              </span>
              {i < CHANGES.length - 1 && (
